...
Digital Technologies Core organizes services into 4 distinct classifications based on their usage patterns and dependencies:
...
git clone https://srbooysen@bitbucket.org/shopritelabs/digital-technologies-core.git
cd digital-technologies-core
...
For issues, questions, or contributions, please contact the Digital Technologies Team or open an issue in the repository.
