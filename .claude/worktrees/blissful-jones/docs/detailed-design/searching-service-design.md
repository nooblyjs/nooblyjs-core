...
- `this.QUEUE_INDEXING_` – queue name (default: `'digital-technologies-core-searching'`).

### Settings

| Setting | Type | Default | Description |
|---|---|---|---|
| `QUEUE_INDEXING` | string | `'digital-technologies-core-searching'` | Queue name for batch indexing |
