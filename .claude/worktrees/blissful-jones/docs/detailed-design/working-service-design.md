...
|---|---|---|
| `QUEUE_INCOMING_` | `digital-technologies-core-working-incoming` | Tasks waiting to execute |
| `QUEUE_COMPLETE_` | `digital-technologies-core-working-complete` | Completed tasks |
| `QUEUE_ERROR_` | `digital-technologies-core-working-error` | Failed tasks |
