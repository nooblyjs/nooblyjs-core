/**
 * @fileoverview Digital Technologies Core - View Renderer Base Class
 * Base class for implementing view rendering and static file serving in Digital Technologies Core.
