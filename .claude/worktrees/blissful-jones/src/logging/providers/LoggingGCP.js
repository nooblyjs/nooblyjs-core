/**
 * @fileoverview GCP Cloud Logging provider for Digital Technologies Core
...
class LoggingGCP {
   ...
   * @param {string} options.logName Name of the log in Cloud Logging (default: 'digital-technologies-core-logs')
  ...
  constructor(options = {}, eventEmitter) {
    ...
    this.logName_ = options.logName || 'digital-technologies-core-logs';
