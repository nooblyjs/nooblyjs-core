/**
 * @fileoverview AWS CloudWatch logging provider for Digital Technologies Core
...
class LoggingAWS {
  ...
  constructor(options = {}, eventEmitter) {
    ...
    this.logGroup_ = options.logGroup || process.env.AWS_LOG_GROUP || 'digital-technologies-core-logs';
