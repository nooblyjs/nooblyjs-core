...
class SchedulingAnalytics {
  constructor() {
    // Map of schedule name -> { schedule, pending, running, completed, error, lastRun, cron, activity, createdAt }
    ...
    this.executionHistory = new Map(); // scheduleId -> array of execution records
  }
