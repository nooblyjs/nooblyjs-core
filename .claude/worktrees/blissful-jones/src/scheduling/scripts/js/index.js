/**
 * @fileoverview Digital Technologies Core Caching Client Library
 * A client-side JavaScript library for interacting with the Digital Technologies Core caching service.
