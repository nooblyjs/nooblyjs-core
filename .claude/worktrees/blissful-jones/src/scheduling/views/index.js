/**
 * @fileoverview Scheduling service views module for digital-technologies-core framework.
 ...
 * @param {Object} scheduler - The scheduling service provider instance
 * @returns {void}
 * 
 * @example
 * const express = require('express');
 ...
 * schedulingViews({
 *   'express-app': app
 * }, eventEmitter, schedulingService);
 */
