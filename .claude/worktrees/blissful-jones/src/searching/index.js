...
const SearchTokenService = require('./providers/searchingTokens.js');
 ...
 * @param {string} type - The search service type ('default', 'files', 'api', 'tokens')
 ...
 * @return {SearchService|SearchFileService|SearchingApi|SearchTokenService} Search service instance for indexing and querying
...
function createSearchService(type, options, eventEmitter) {
  ...
  switch (type) {
    ...
    case 'files':
      ...
      break;
    case 'tokens':
      searching = new SearchTokenService(providerOptions, eventEmitter, dependencies);
      break;
    case 'default':
    default:
