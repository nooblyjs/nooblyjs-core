...
class SearchService {
  ...
  constructor(options = {}, eventEmitter, dependencies = {}) {
    ...
    this.settings.list = [
      {setting: "QUEUE_INDEXING", type: "string", values : ['digital-technologies-core-searching']}
    ];
    this.settings.QUEUE_INDEXING = options.QUEUE_INDEXING || this.settings.QUEUE_INDEXING || 'digital-technologies-core-searching';
