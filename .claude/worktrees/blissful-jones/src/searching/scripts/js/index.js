/**
 * @fileoverview Digital Technologies Core Searching Client Library
 * A client-side JavaScript library for interacting with the Digital Technologies Core Searching service.
...
(function(global) {
  ...
  /**
   * Client-side Search Service for Digital Technologies Core
