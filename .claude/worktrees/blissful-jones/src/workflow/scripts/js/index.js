/**
 * @fileoverview Digital Technologies Core workflow Client Library
 * A client-side JavaScript library for interacting with the Digital Technologies Core workflow service.
