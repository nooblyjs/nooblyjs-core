 ...
 * - digital-technologies-core-working-incoming: Tasks waiting to be processed
 * - digital-technologies-core-working-complete: Successfully completed tasks
 * - digital-technologies-core-working-error: Failed tasks
 * @class
 */
class WorkerManager {
  /**
  ...
  constructor(options = {}, eventEmitter) {
    ...
    this.activitiesFolder_ = options.activitiesFolder || options['digital-technologies-core-activities'] || 'activities';
    ...
    this.QUEUE_INCOMING_ = 'digital-technologies-core-working-incoming';
    /** @private @const {string} Queue name for completed tasks */
    this.QUEUE_COMPLETE_ = 'digital-technologies-core-working-complete';
    /** @private @const {string} Queue name for error tasks */
    this.QUEUE_ERROR_ = 'digital-technologies-core-working-error';
