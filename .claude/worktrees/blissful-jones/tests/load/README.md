...
Comprehensive load testing framework for all Digital Technologies Core services. Tests both direct service providers and HTTP API endpoints with API key authentication support.
...
```
=== Digital Technologies Core Load Testing Suite ===
Test Type: http
Scenario: standard
Configuration: {
