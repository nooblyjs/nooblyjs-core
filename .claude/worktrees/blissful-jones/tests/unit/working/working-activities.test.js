...
`;
  ...
  it('should use digital-technologies-core-activities option name', async () => {
    // Stop current service
    await workingService.stop();
    ...
    // Create service with digital-technologies-core-activities option
    workingService = createWorkingService('default', {
      maxThreads: 2,
      'digital-technologies-core-activities': testActivitiesDir,
      dependencies: {
        queueing: queueService,
        filing: filingService
      }
