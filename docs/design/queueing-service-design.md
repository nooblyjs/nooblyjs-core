...
| Queue Name | Purpose |
|---|---|
| `nooblyjs-core-working-incoming` | Tasks waiting to be picked up by a worker thread |
| `nooblyjs-core-working-complete` | Tasks that completed successfully |
| `nooblyjs-core-working-error` | Tasks that failed |
