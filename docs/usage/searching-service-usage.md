...
The searching service is automatically available at `/services/searching/api` when the nooblyjs-core server is running.
...
- [Noobly JS Core Documentation](./nooblyjs-core-usage.md)
